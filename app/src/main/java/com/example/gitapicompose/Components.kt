...
fun ReposListItem(
    ...
    repositoriesModelItem: RepositoriesModel.RepositoriesModelItem
) {
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = repositoriesModelItem.fullName?.substringBefore(delimiter = "/")
                        .toString(), fontSize = 16.sp
                )
            }
            Spacer(modifier = Modifier.height(5.dp))
            Text(
                text = repositoriesModelItem.name.toString(),
                fontSize = 18.sp,
